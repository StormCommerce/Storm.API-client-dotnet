...
{
    public class VerifoneCallbackHandler : AbstractCallbackHandler
    {
        private readonly IRepository repository;

        public VerifoneCallbackHandler()
        {
        ...
        public VerifoneCallbackHandler(IRepository repository)
        {
        ...
        private static Expose.NameValues GetParameters(HttpContext context)
        {
            ...
            parameters.Add(new Expose.NameValue { Name = "PaymentService", Value = "Verifone" });
